...
namespace API.Migrations
{
    ...
    [Migration("20241128122823_InitialCreate")]
            ...
            modelBuilder.Entity("API.Models.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2024, 11, 29, 9, 28, 22, 722, DateTimeKind.Local).AddTicks(1681),
                            Nome = "Trabalho"
                        },
                        new
                        {
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 11, 30, 9, 28, 22, 722, DateTimeKind.Local).AddTicks(1902),
                            Nome = "Estudos"
                        },
                        new
                        {
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 12, 1, 9, 28, 22, 722, DateTimeKind.Local).AddTicks(1911),
                            Nome = "Lazer"
                        });
                });
            ...
            modelBuilder.Entity("API.Models.Tarefa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoriaId = "bfe4e7dc-81e4-4e47-a67b-d4fbf3e124bd",
                            CriadoEm = new DateTime(2024, 12, 5, 9, 28, 22, 722, DateTimeKind.Local).AddTicks(6020),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 12, 1, 9, 28, 22, 722, DateTimeKind.Local).AddTicks(6279),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 12, 12, 9, 28, 22, 722, DateTimeKind.Local).AddTicks(6295),
